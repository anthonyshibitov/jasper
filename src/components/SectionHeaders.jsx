          ...
          <tbody className="third-color">
            ...
            <tr>
              ...
              <td>
                ...
                {(parseInt(header.Characteristics, 16) & 0x8) == 0x8 && (
