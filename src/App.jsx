  ...
  return (
    <div className="app-wrapper">
      ...
      <div className="button-wrapper">
        ...
        <div className="button-under-label">NOTE: This only supports 32 bit at the moment.</div>
      </div>
      ...
      <>
        ...
        <ImportHeader importDescriptors={pe._IMAGE_NT_HEADER._IMAGE_OPTIONAL_HEADER32.DataDirectory[1]}/>
      </>
      }
    </div>
  );
